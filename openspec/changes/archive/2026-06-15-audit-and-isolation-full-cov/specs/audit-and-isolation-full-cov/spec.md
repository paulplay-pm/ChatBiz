<!--
Delta spec for capability `audit-and-isolation-full-cov`.

源: openspec/changes/audit-and-isolation-full-cov/{brainstorm,proposal,design}.md
触发源: openspec/changes/archive/2026-06-15-llm-client-retry-coverage/retrospective.md §4.4
-->
