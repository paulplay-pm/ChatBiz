...
> **eng-review refs:** [ENG-Arch #4, #5], [ENG-Quality #2], [ENG-Perf #1]
> **depends on:** [plugin-market], [knowledge-base], [skill-management], [credential-management], [audit-and-isolation]
> **source:** `docs/prd.md` §4.2, `docs/architecture.md` §4.3.2
