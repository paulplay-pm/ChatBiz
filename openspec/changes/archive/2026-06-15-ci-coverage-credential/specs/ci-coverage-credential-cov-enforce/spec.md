<!--
Delta spec for capability `ci-coverage-credential-cov-enforce`.

源：openspec/changes/ci-coverage-credential/{brainstorm,proposal,design}.md
触发源：
  openspec/changes/archive/2026-06-15-ci-coverage-all-services/retrospective.md §4.1
-->
